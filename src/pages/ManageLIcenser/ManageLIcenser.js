...
import './ManageLicenser.css';
import { error } from 'jquery';


const ManageLIcenser=()=>{
 ...
 async function updateLicenser(userId){
    ...
    <div className="Dashboard"> 
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="/managelicenser" class="active">
    ...
    <section class="home-section">
      ...
      <i className={`bx ${sidebarActive ? 'bx-menu-alt-right' : 'bx-menu'} sidebarBtn`}><FontAwesomeIcon icon={faBars}/></i>
          <span class="dashboard">Manage Licensers</span>
        </div>
